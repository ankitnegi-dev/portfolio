...
A single fixed search radius fails constantly - too small in a city, uselessly large in a suburb. Nearby Vibes retries automatically: it queries a 1.5km radius first, and if that comes back empty, **widens to 5km, then 10km**, without the user having to manually adjust anything.
